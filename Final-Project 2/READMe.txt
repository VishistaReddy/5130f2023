...
- Ability to fully customize features and functionality to exact business needs
- Leveraging the power and widespread adoption of Java for web applications
- Support for modern architectural approaches like MVC to aid extensibility 
- Cost savings relative to purchasing proprietary software
- More control compared to open-source solutions with hardcoded features

The goal is to develop an intuitive, user-friendly application providing all required e-commerce capabilities. The use of standard Java frameworks aligned with MVC principles aims to achieve a flexible foundation for current needs with the ability to adapt to future business requirements.



launch instructions: 
1. Provision infrastructure - Install and configure Linux, Tomcat, and MySQL on on-prem or cloud infrastructure.

2. Deploy WAR file - Deploy the generated WAR file from the build process to the Tomcat web apps folder.

3. Database setup - Create schema, tables, and seed data based on the application data model.

4. Configure app - Update configuration files, access credentials, connection URLs, etc.

5. Smoke testing - Validate deployment, connectivity across app layers, and basic functionality.
